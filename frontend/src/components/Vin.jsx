  ...
  return (
    <div className="overflow-x-auto m-4 bg-white rounded-lg p-4">
      <div className="flex justify-between mb-4">
        ...
        <div>
          <button className="bg-indigo-500 text-white px-4 mr-2 py-2 rounded hover:bg-indigo-600"> <FontAwesomeIcon className='mr-2' icon={faPlus} />Ajouter un vin</button>
        ...
        <thead className='text-indigo-500 text-left'>
          <tr>
            ...
            <th className="px-4 py-4" onClick={() => handleSort('num_vin')}>
              #<FontAwesomeIcon className="float-right text-indigo-200 hover:text-indigo-600" icon={sortColumn === 'num_vin' ? (sortType === 'asc' ? faSortUp : faSortDown) : faSort} />
            </th>
            ...
            <th className="px-4 py-4" onClick={() => handleSort('prix')}>
              Prix(€)<FontAwesomeIcon className="float-right text-indigo-200 hover:text-indigo-600" icon={sortColumn === 'prix' ? (sortType === 'asc' ? faSortUp : faSortDown) : faSort} />
            </th>
