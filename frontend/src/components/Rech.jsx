          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <div className='md:ml-2 flex'>
                ...
                <span>
                  <select
                    className={`w-full p-2 mt-2 mb-3 ml-2 order border-slate-200 rounded-lg ${parseInt(secondPriceValue) < firstPriceValue ? 'bg-red-200 border border-red-500 text-red-500 font-semibold' : ''}`}
            ...
            <div>
              ...
              <div className='md:ml-2 flex'>
                ...
                <span>
                  <select
                    className={`w-full p-2 mt-2 mb-3 ml-2 order border-slate-200 rounded-lg ${parseInt(secondAlcoholValue) < firstAlcoholValue ? 'bg-red-200 border border-red-500 text-red-500 font-semibold' : ''}`}
            ...
            <div key={vin.id} className="rounded-xl bg-white p-4 m-4 shadow-lg flex">
              ...
              <div className='flex-grow p-4'>
                <div>
                  ...
                  <p className='text-slate-400 mt-2 mb-3'>{vin.num_vin}</p>
